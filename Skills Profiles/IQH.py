...
for f in glob.glob('/Users/adamlewis/Documents/Work/Business Consultancy/Skills and Development/Combined Skills Profiles 2021/*.xlsx'):
	...
	PersonScore = sh["F22"].value
	PersonTarget = sh["F23"].value
	PersonVariance = sh["F24"].value
...
# add a total column and calculate scores (which should match the score showing in the details tab))
...
all_data.to_excel(writer, "IQH", index = False)
