...
for f in glob.glob('/Users/adamlewis/Documents/Work/Business Consultancy/Skills and Development/Combined Skills Profiles 2021/*.xlsx'):
	...
	PersonScore = sh["H22"].value
	PersonTarget = sh["H23"].value
	PersonVariance = sh["H24"].value
	...
	ws = wb["Common Components"]
	df_BA = load_workbook_range('A1:C55', ws)
...
all_data.to_excel(writer, "Common Components", index = False)
