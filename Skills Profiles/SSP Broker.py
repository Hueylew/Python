...
for f in glob.glob('/Users/adamlewis/Documents/Work/Business Consultancy/Skills and Development/Combined Skills Profiles 2021/*.xlsx'):
	...
	PersonScore = sh["E22"].value
	PersonTarget = sh["E23"].value
	PersonVariance = sh["E24"].value
	...
	ws = wb["SSP Broker"]
	df_BA = load_workbook_range('A1:C104', ws)
...
all_data.to_excel(writer, "SSP Broker", index = False)
